import { useFilteredList } from "@lotioncode-ai/ui/hooks"
import {
  createEffect,
  on,
  Component,
...
import { FileIcon } from "@lotioncode-ai/ui/file-icon"
...
import { Select } from "@lotioncode-ai/ui/select"
import { getDirectory, getFilename, getFilenameTruncated } from "@lotioncode-ai/util/path"
import { useDialog } from "@lotioncode-ai/ui/context/dialog"
import { ImagePreview } from "@lotioncode-ai/ui/image-preview"
...
import { createOpencodeClient, type Message, type Part } from "@lotioncode-ai/sdk/v2/client"
