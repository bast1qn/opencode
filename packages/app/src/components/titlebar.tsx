...
import { useTheme } from "@lotioncode-ai/ui/theme"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div id="lotioncode-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
      </div>
      ...
      <div class="min-w-0 flex items-center justify-center pointer-events-none lg:absolute lg:inset-0 lg:flex lg:items-center lg:justify-center">
        <div id="lotioncode-titlebar-center" class="pointer-events-auto w-full min-w-0 flex justify-center lg:w-fit" />
      </div>
      ...
      <div
        ...
        onMouseDown={drag}
      >
        <div id="lotioncode-titlebar-right" class="flex items-center gap-3 shrink-0 justify-end" />
        <Show when={windows()}>
