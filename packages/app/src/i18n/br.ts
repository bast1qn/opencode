export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo LotionCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no LotionCode.",
  ...
  "provider.connect.lotioncodeZen.line1":
    "LotionCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.lotioncodeZen.visit.prefix": "Visite ",
  "provider.connect.lotioncodeZen.visit.link": "lotioncode.ai/zen",
  "provider.connect.lotioncodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no LotionCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no LotionCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em lotioncode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor LotionCode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do LotionCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do LotionCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (lotioncode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: LotionCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "LotionCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do LotionCode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o LotionCode aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o LotionCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o LotionCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do LotionCode.",
