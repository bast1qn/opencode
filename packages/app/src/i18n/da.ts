export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af LotionCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i LotionCode.",
  ...
  "provider.connect.lotioncodeZen.line1":
    "LotionCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.lotioncodeZen.visit.prefix": "Besøg ",
  "provider.connect.lotioncodeZen.visit.link": "lotioncode.ai/zen",
  "provider.connect.lotioncodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i LotionCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i LotionCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i lotioncode.json",
  ...
  "dialog.server.description": "Skift hvilken LotionCode-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af LotionCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til LotionCode-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (lotioncode.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, LotionCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "LotionCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for LotionCode",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan LotionCode ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan LotionCode er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når LotionCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af LotionCode.",
