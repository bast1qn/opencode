...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von LotionCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in LotionCode zu nutzen.",
  ...
  "provider.connect.lotioncodeZen.line1":
    "LotionCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.lotioncodeZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.lotioncodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.lotioncodeZen.visit.link": "lotioncode.ai/zen",
  "provider.connect.lotioncodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in LotionCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in LotionCode zu nutzen.",
  ...
  "dialog.plugins.empty": "In lotioncode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den LotionCode-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von LotionCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem LotionCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (lotioncode.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: LotionCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "LotionCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "LotionCode Desktop",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für LotionCode ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie LotionCode auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von LotionCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von LotionCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von LotionCode.",
