export const dict = {
  ...
  "dialog.provider.lotioncode.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by LotionCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in LotionCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.lotioncodeZen.line1":
    "LotionCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.lotioncodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.lotioncodeZen.visit.prefix": "Visit ",
  "provider.connect.lotioncodeZen.visit.link": "lotioncode.ai/zen",
  "provider.connect.lotioncodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in LotionCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in LotionCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in lotioncode.json",
  ...
  "dialog.server.description": "Switch which LotionCode server this app connects to.",
  ...
  "toast.update.description": "A new version of LotionCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the LotionCode team",
  ...
  "error.chain.checkConfig": "Check your config (lotioncode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, LotionCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "LotionCode includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for LotionCode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how LotionCode looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how LotionCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when LotionCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of LotionCode.",
