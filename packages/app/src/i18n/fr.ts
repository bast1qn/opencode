export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par LotionCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans LotionCode.",
  ...
  "provider.connect.lotioncodeZen.line1":
    "LotionCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.lotioncodeZen.visit.prefix": "Visitez ",
  "provider.connect.lotioncodeZen.visit.link": "lotioncode.ai/zen",
  "provider.connect.lotioncodeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans LotionCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans LotionCode.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans lotioncode.json",
  ...
  "dialog.server.description": "Changez le serveur LotionCode auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'LotionCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe LotionCode",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (lotioncode.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'LotionCode ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "LotionCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour LotionCode",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'LotionCode sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'LotionCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'LotionCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'LotionCode.",
