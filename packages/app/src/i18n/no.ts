...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av LotionCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i LotionCode.",
  ...
  "provider.connect.lotioncodeZen.line1":
    "LotionCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.lotioncodeZen.visit.prefix": "Besøk ",
  "provider.connect.lotioncodeZen.visit.link": "lotioncode.ai/zen",
  "provider.connect.lotioncodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i LotionCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i LotionCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i lotioncode.json",
  ...
  "dialog.server.description": "Bytt hvilken LotionCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av LotionCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til LotionCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (lotioncode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at LotionCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "LotionCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for LotionCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan LotionCode ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan LotionCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når LotionCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av LotionCode.",
