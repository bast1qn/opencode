...
import video from "../asset/lander/lotioncode-min.mp4"
import videoPoster from "../asset/lander/lotioncode-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="lotioncode">
      {/*<HttpHeader name="Cache-Control" value="public, max-age=1, s-maxage=3600, stale-while-revalidate=86400" />*/}
      <Title>LotionCode | The open source AI coding agent</Title>
        ...
        <div data-component="content">
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="curl">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span data-slot="command-script">
                        ...
                        <span data-slot="highlight">lotioncode.ai/install</span>
                        <span> | bash</span>
                      </span>
                      <CopyStatus />
                    </button>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">lotioncode-ai</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">anomalyco/tap/lotioncode</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  <Tabs.Content as="pre" data-slot="panel" value="paru">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">lotioncode</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
          ...
          <section data-component="what">
            <div data-slot="section-title">
              <h3>What is LotionCode?</h3>
              <p>LotionCode is an open source agent that helps you write code in your terminal, IDE, or desktop.</p>
            </div>
            <ul>
              <li>
                <span>[*]</span>
            ...
            <div data-slot="section-title">
              ...
              <div>
                ...
                <p>
                  ...
                  <strong>{config.stats.commits}</strong> commits, LotionCode is used and trusted by over{" "}
          ...
          <section data-component="privacy">
            <div data-slot="privacy-title">
              ...
              <div>
                ...
                <p>
                  LotionCode does not store any of your code or context data, so that it can operate in privacy sensitive
          ...
          <section data-component="faq">
            ...
            <ul>
              <li>
                <Faq question="What is LotionCode?">
                  LotionCode is an open source agent that helps you write and run code with any AI model. It's available
                  as a terminal-based interface, desktop app, or IDE extension.
                </Faq>
              </li>
              <li>
                <Faq question="How do I use LotionCode?">
                  The easiest way to get started is to read the <a href="/docs">intro</a>.
                </Faq>
              </li>
              <li>
                <Faq question="Do I need extra AI subscriptions to use LotionCode?">
                  Not necessarily, LotionCode comes with a set of free models that you can use without creating an
                  account. Aside from these, you can use any of the popular coding models by creating a{" "}
                  <A href="/zen">Zen</A> account. While we encourage users to use Zen, LotionCode also works with all
              ...
              <li>
                <Faq question="Can I use my existing AI subscriptions with LotionCode?">
                  Yes, LotionCode supports subscription plans from all major providers. You can use your Claude Pro/Max,
                  ChatGPT Plus/Pro, or GitHub Copilot subscriptions. <a href="/docs/providers/#directory">Learn more</a>
                  .
                </Faq>
              </li>
              <li>
                <Faq question="Can I only use LotionCode in the terminal?">
                  Not anymore! LotionCode is now available as an app for your <a href="/download">desktop</a> and{" "}
                  <a href="/docs/web">web</a>!
                </Faq>
              </li>
              <li>
                <Faq question="How much does LotionCode cost?">
                  LotionCode is 100% free to use. It also comes with a set of free models. There might be additional costs
              ...
              <li>
                <Faq question="Is LotionCode open source?">
                  Yes, LotionCode is fully open source. The source code is public on{" "}
          ...
          <section data-component="zen-cta">
            <div data-slot="zen-cta-copy">
              ...
              <p>
                Zen gives you access to a handpicked set of AI models that LotionCode has tested and benchmarked
