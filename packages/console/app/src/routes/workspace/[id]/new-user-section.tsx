...
import { Key } from "@lotioncode-ai/console-core/key.js"
    ...
    <Show when={isNew()}>
      <div class={styles.root}>
        <div data-component="feature-grid">
          ...
          <div data-slot="feature">
            <h3>No Lock-in</h3>
            <p>Use Zen with any coding agent, and continue using other providers with lotioncode whenever you want.</p>
          </div>
        </div>
        ...
        <div data-component="next-steps">
          <ol>
            ...
            <li>
              Run <code>lotioncode auth login</code> and select lotioncode
            </li>
            <li>Paste your API key</li>
            <li>
              Start lotioncode and run <code>/models</code> to select a model
            </li>
          </ol>
        </div>
      </div>
