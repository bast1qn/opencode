...
import compareVideo from "../../asset/lander/lotioncode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/lotioncode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Title>LotionCode Zen | A curated set of reliable optimized models for coding agents</Title>
      <Link rel="canonical" href={`${config.baseUrl}/zen`} />
      <Meta property="og:image" content="/social-share-zen.png" />
      <Meta name="twitter:image" content="/social-share-zen.png" />
      <Meta name="lotioncode:auth" content={loggedin() ? "true" : "false"} />
        ...
        <div data-component="content">
          <section data-component="hero">
            <div data-slot="hero-copy">
              ...
              <p>
                Zen gives you access to a curated set of AI models that LotionCode has tested and benchmarked specifically
          ...
          <section data-component="problem">
            ...
            <p>We're fixing this for everyone, not just LotionCode users.</p>
            <ul>
              <li>
          ...
          <section data-component="how">
            <div data-slot="section-title">
              <h3>How Zen works</h3>
              <p>While we suggest you use Zen with LotionCode, you can use Zen with any agent.</p>
            </div>
            <ul>
              <li>
                <span>[1]</span>
          ...
          <section data-component="testimonials">
            ...
            <a href="https://x.com/thdxr/status/1973531687629017227">
              <div data-slot="testimonial">
                ...
                <div data-slot="quote">
                  <span>@LotionCode</span> Zen has been life changing, it's truly a no-brainer.
                </div>
              </div>
            </a>
            {/*Jay*/}
            <a href="https://x.com/jayair/status/1973530190870618456">
              <div data-slot="testimonial">
                ...
                <div data-slot="quote">
                  4 out of 5 people on our team love using <span>@LotionCode</span> Zen.
                </div>
              </div>
            </a>
            {/*Adam*/}
            <a href="https://x.com/adamdotdev/status/1973732040718860563">
              <div data-slot="testimonial">
                ...
                <div data-slot="quote">
                  I can't recommend <span>@LotionCode</span> Zen enough. Seriously, it’s really good.
                </div>
              </div>
            </a>
            {/*David*/}
            <a href="https://x.com/iamdavidhill/status/1973530568773214622">
              <div data-slot="testimonial">
                ...
                <div data-slot="quote">
                  With <span>@LotionCode</span> Zen I know all the models are tested and perfect for coding agents.
                </div>
              </div>
            </a>
            {/*Frank*/}
          ...
          <section data-component="faq">
            ...
            <ul>
              <li>
                <Faq question="What is LotionCode Zen?">
              ...
              <li>
                <Faq question="Is Zen cheaper?">
                  ...
                  usage the more LotionCode can negotiate better rates and pass those to you.
                </Faq>
              </li>
              <li>
                <Faq question="How much does Zen cost?">
                  ...
                  your <a href="/auth">account</a>. To cover costs, LotionCode adds only a small payment processing fee of
              ...
              <li>
                <Faq question="Can I use Zen with other coding agents?">
                  While Zen works great with LotionCode, you can use Zen with any agent. Follow the setup instructions in
