export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do LotionCode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do LotionCode foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada em {{path}}\n\nReinicie seu terminal para usar o comando 'lotioncode'.",
  "desktop.cli.failed.title": "Falha na instalação",
  "desktop.cli.failed.message": "Falha ao instalar a CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "Falha ao iniciar o LotionCode",
  "desktop.error.serverStartFailed.description":
    "Não foi possível iniciar o servidor local do LotionCode. Reinicie o aplicativo ou verifique suas configurações de rede (VPN/proxy) e tente novamente.",
}
