export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af LotionCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af LotionCode er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'lotioncode'-kommandoen.",
  ...
  "desktop.error.serverStartFailed.description":
    "Den lokale LotionCode-server kunne ikke startes. Genstart appen, eller tjek dine netværksindstillinger (VPN/proxy) og prøv igen.",
}
