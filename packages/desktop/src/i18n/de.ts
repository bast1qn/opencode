export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von LotionCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von LotionCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'lotioncode' zu verwenden.",
  "desktop.cli.failed.title": "Installation fehlgeschlagen",
  "desktop.cli.failed.message": "CLI konnte nicht installiert werden: {{error}}",

  "desktop.error.serverStartFailed.title": "LotionCode konnte nicht gestartet werden",
  "desktop.error.serverStartFailed.description":
    "Der lokale LotionCode-Server konnte nicht gestartet werden. Starten Sie die App neu oder überprüfen Sie Ihre Netzwerkeinstellungen (VPN/Proxy) und versuchen Sie es erneut.",
}
