export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of LotionCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of LotionCode has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'lotioncode' command.",
  "desktop.cli.failed.title": "Installation Failed",
  "desktop.cli.failed.message": "Failed to install CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "LotionCode failed to start",
  "desktop.error.serverStartFailed.description":
    "The local LotionCode server could not be started. Restart the app, or check your network settings (VPN/proxy) and try again.",
}
