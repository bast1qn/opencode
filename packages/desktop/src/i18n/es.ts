export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de LotionCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de LotionCode. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada en {{path}}\n\nReinicia tu terminal para usar el comando 'lotioncode'.",
  "desktop.cli.failed.title": "Instalación fallida",
  "desktop.cli.failed.message": "No se pudo instalar la CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "LotionCode no pudo iniciarse",
  "desktop.error.serverStartFailed.description":
    "No se pudo iniciar el servidor local de LotionCode. Reinicia la aplicación o revisa tu configuración de red (VPN/proxy) y vuelve a intentarlo.",
}
