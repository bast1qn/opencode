export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'LotionCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'LotionCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'lotioncode'.",
  "desktop.cli.failed.title": "Échec de l'installation",
  "desktop.cli.failed.message": "Impossible d'installer la CLI : {{error}}",

  "desktop.error.serverStartFailed.title": "Échec du démarrage d'LotionCode",
  "desktop.error.serverStartFailed.description":
    "Impossible de démarrer le serveur LotionCode local. Redémarrez l'application ou vérifiez vos paramètres réseau (VPN/proxy) et réessayez.",
}
