export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av LotionCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av LotionCode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke 'lotioncode'-kommandoen.",
  "desktop.cli.failed.title": "Installasjon mislyktes",
  "desktop.cli.failed.message": "Kunne ikke installere CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "LotionCode kunne ikke starte",
  "desktop.error.serverStartFailed.description":
    "Den lokale LotionCode-serveren kunne ikke startes. Start appen på nytt, eller sjekk nettverksinnstillingene dine (VPN/proxy) og prøv igjen.",
}
