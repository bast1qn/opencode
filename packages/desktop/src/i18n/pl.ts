export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji LotionCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} LotionCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'lotioncode'.",
  "desktop.cli.failed.title": "Instalacja nie powiodła się",
  "desktop.cli.failed.message": "Nie udało się zainstalować CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "Nie udało się uruchomić LotionCode",
  "desktop.error.serverStartFailed.description":
    "Nie udało się uruchomić lokalnego serwera LotionCode. Uruchom ponownie aplikację lub sprawdź ustawienia sieciowe (VPN/proxy) i spróbuj ponownie.",
}
