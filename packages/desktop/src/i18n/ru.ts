export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию LotionCode",
  ...
  "desktop.updater.downloaded.prompt": "Версия LotionCode {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'lotioncode'.",
  "desktop.cli.failed.title": "Ошибка установки",
  "desktop.cli.failed.message": "Не удалось установить CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "Не удалось запустить LotionCode",
  "desktop.error.serverStartFailed.description":
    "Не удалось запустить локальный сервер LotionCode. Перезапустите приложение или проверьте настройки сети (VPN/proxy) и попробуйте снова.",
}
