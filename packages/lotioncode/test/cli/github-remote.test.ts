...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/lotioncode.git")).toEqual({ owner: "sst", repo: "lotioncode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/lotioncode")).toEqual({ owner: "sst", repo: "lotioncode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/lotioncode.git")).toEqual({ owner: "sst", repo: "lotioncode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/lotioncode")).toEqual({ owner: "sst", repo: "lotioncode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/lotioncode.git")).toEqual({ owner: "sst", repo: "lotioncode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/lotioncode")).toEqual({ owner: "sst", repo: "lotioncode" })
})
