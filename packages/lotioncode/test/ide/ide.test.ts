...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders LOTIONCODE_CALLER", () => {
    process.env["LOTIONCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode LOTIONCODE_CALLER", () => {
    process.env["LOTIONCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown LOTIONCODE_CALLER", () => {
    process.env["LOTIONCODE_CALLER"] = "unknown"
