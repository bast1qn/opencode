...
const mockPlugin = () => ({})
mock.module("lotioncode-copilot-auth", () => ({ default: mockPlugin }))
mock.module("lotioncode-anthropic-auth", () => ({ default: mockPlugin }))
mock.module("@gitlab/lotioncode-gitlab-auth", () => ({ default: mockPlugin }))
