...
import type { MessageV2 } from "lotioncode/session/message-v2"
import type { Message } from "lotioncode/session/message"
import type { Session } from "lotioncode/session/index"
        ...
        <div data-component="header">
          ...
          <div data-component="header-details">
            <ul data-component="header-stats">
              <li title="lotioncode version" data-slot="item">
                <div data-slot="icon" title="lotioncode">
