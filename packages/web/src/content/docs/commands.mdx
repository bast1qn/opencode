...
Create `.lotioncode/commands/test.md`:

```md title=".lotioncode/commands/test.md"
---
...
You can add custom commands through the LotionCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your LotionCode [config](/docs/config):

```json title="lotioncode.jsonc" {4-12}
{
...
- Global: `~/.config/lotioncode/commands/`
- Per-project: `.lotioncode/commands/`

```markdown title="~/.config/lotioncode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".lotioncode/commands/component.md"
---
...
```md title=".lotioncode/commands/create-file.md"
---
...
```md title=".lotioncode/commands/analyze-coverage.md"
---
...
```md title=".lotioncode/commands/review-changes.md"
---
...
```md title=".lotioncode/commands/review-component.md"
---
...
lotioncode includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
