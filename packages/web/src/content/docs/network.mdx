...
LotionCode supports standard proxy environment variables and custom certificates for enterprise network environments.

---

## Proxy

LotionCode respects standard proxy environment variables.
...
If your enterprise uses custom CAs for HTTPS connections, configure LotionCode to trust them.
