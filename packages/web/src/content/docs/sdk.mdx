---
title: SDK
description: Type-safe JS client for lotioncode server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The lotioncode JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control lotioncode programmatically.
...
Create an instance of lotioncode:
...
You can pass a configuration object to customize behavior. The instance still picks up your `lotioncode.json`, but you can override or add configuration inline:
...
console.log(`Server running at ${lotioncode.server.url}`)
...
If you already have a running instance of lotioncode, you can create a client instance to connect to it:
...
```typescript
import type { Session, Message, Part } from "@lotioncode-ai/sdk"
```
...
const textResults = await client.find.text({
  query: { pattern: "function.*lotioncode" },
})
