---
title: TUI
description: Using the LotionCode terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LotionCode provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running LotionCode starts the TUI for the current directory.
...
When using the LotionCode TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to LotionCode. Allows you to select from available providers and add their API keys.
...
Exit LotionCode. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your LotionCode config file.
