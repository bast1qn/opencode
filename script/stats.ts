...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/lotioncode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/lotioncode...\n")
...
console.log("Fetching npm all-time downloads for lotioncode-ai...\n")
const npmDownloads = await fetchNpmDownloads("lotioncode-ai")
